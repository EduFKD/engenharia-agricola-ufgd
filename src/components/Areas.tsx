...
const areas = [
  {
    ...
    image: import.meta.env.BASE_URL + "maquinas.png?v=3",
  ...
  },
  {
    ...
    image: import.meta.env.BASE_URL + "irrigacao.png?v=3",
  ...
  },
  {
    ...
    image: import.meta.env.BASE_URL + "construcao-ambiencia.png?v=3",
  ...
  },
  {
    ...
    image: import.meta.env.BASE_URL + "pos-colheita.png?v=3",
  ...
  },
  {
    ...
    image: import.meta.env.BASE_URL + "energia.png?v=3",
